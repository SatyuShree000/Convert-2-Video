...
@pyrogram.Client.on_message(pyrogram.Filters.command(["gct"]))
async def generate_custom_thumbnail(bot, update):
    if update.from_user.id in Config.BANNED_USERS:
        ...
        return
    TRChatBase(update.from_user.id, update.text, "gct")
...
@pyrogram.Client.on_message(pyrogram.Filters.command(["dt"]))
async def delete_thumbnail(bot, update):
    if update.from_user.id in Config.BANNED_USERS:
        ...
        return
    TRChatBase(update.from_user.id, update.text, "dt")
